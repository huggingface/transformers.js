...
export type MessageHandler = (message: ExtensionMessage, sender: any, sendResponse: (response: ExtensionResponse) => void) => boolean | void;
export type TabMessageHandler = (message: ExtensionMessage, sender: any, sendResponse: (response: ExtensionResponse) => void) => boolean | void;
