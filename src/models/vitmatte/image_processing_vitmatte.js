...
export class VitMatteImageProcessor extends ImageProcessor {
     ...
     * @returns {Promise<import("../../base/image_processors_utils.js").ImageFeatureExtractorResult>} An object containing the concatenated pixel values of the preprocessed images.
     */
