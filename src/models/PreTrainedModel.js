...
import { Tensor, DataTypeMap, full_like, cat, zeros_like, toI64Tensor, ones_like } from '../utils/tensor.js';
import {
    decoderForward,
...
import { PretrainedMixin } from '../models.js';

// import all classes
import { ASTModel, ASTForAudioClassification } from './classes/ASTPreTrainedModel.js';
import {
    AlbertModel,
    AlbertForSequenceClassification,
    AlbertForQuestionAnswering,
    AlbertForMaskedLM,
} from './classes/AlbertPreTrainedModel.js';
import { ApertusModel, ApertusForCausalLM } from './classes/ApertusPreTrainedModel.js';
import { ArceeModel, ArceeForCausalLM } from './classes/ArceePreTrainedModel.js';
import {
    BartModel,
    BartForConditionalGeneration,
    BartForSequenceClassification,
} from './classes/BartPretrainedModel.js';
import { BeitModel, BeitForImageClassification } from './classes/BeitPreTrainedModel.js';
import {
    BertModel,
    BertForMaskedLM,
...
} from './classes/BertPreTrainedModel.js';
import { BlenderbotModel, BlenderbotForConditionalGeneration } from './classes/BlenderbotPreTrainedModel.js';
import {
    BlenderbotSmallModel,
    BlenderbotSmallForConditionalGeneration,
} from './classes/BlenderbotSmallPreTrainedModel.js';
import { BloomModel, BloomForCausalLM } from './classes/BloomPreTrainedModel.js';
import {
    CLIPModel,
    CLIPTextModelWithProjection,
    CLIPVisionModelWithProjection,
} from './classes/CLIPPreTrainedModel.js';
import { CLIPSegModel, CLIPSegForImageSegmentation } from './classes/CLIPSegPreTrainedModel.js';
import {
    CamembertModel,
...
} from './classes/CamembertPreTrainedModel.js';
import { ChatterboxModel } from './classes/ChatterboxPreTrainedModel.js';
import { ChineseCLIPModel } from './classes/ChineseCLIPPreTrainedModel.js';
import { ClapModel, ClapTextModelWithProjection, ClapAudioModelWithProjection } from './classes/ClapPreTrainedModel.js';
import { CodeGenModel, CodeGenForCausalLM } from './classes/CodeGenPreTrainedModel.js';
import { CohereModel, CohereForCausalLM } from './classes/CoherePreTrainedModel.js';
import {
    ConvBertModel,
    ConvBertForMaskedLM,
...
} from './classes/ConvBertPreTrainedModel.js';
import { ConvNextModel, ConvNextForImageClassification } from './classes/ConvNextPreTrainedModel.js';
import { ConvNextV2Model, ConvNextV2ForImageClassification } from './classes/ConvNextV2PreTrainedModel.js';
import { DFineModel, DFineForObjectDetection } from './classes/DFinePreTrainedModel.js';
import { DINOv3ConvNextModel } from './classes/DINOv3ConvNextPreTrainedModel.js';
import { DINOv3ViTModel } from './classes/DINOv3ViTPreTrainedModel.js';
import { DPTModel, DPTForDepthEstimation } from './classes/DPTPreTrainedModel.js';
import { DacModel, DacEncoderModel, DacDecoderModel } from './classes/DacPreTrainedModel.js';
import {
    DebertaModel,
    DebertaForMaskedLM,
...
} from './classes/DebertaPreTrainedModel.js';
import {
    DebertaV2Model,
...
} from './classes/DebertaV2PreTrainedModel.js';
import { DecisionTransformerModel } from './classes/DecisionTransformerPreTrainedModel.js';
import { DeiTPreTrainedModel, DeiTModel, DeiTForImageClassification } from './classes/DeiTPreTrainedModel.js';
import { DepthAnythingForDepthEstimation } from './classes/DepthAnythingPreTrainedModel.js';
import { DepthProForDepthEstimation } from './classes/DepthProPreTrainedModel.js';
import { DetrModel, DetrForObjectDetection, DetrForSegmentation } from './classes/DetrPreTrainedModel.js';
import { Dinov2Model, Dinov2ForImageClassification } from './classes/Dinov2PreTrainedModel.js';
import {
    Dinov2WithRegistersModel,
    Dinov2WithRegistersForImageClassification,
} from './classes/Dinov2WithRegistersPreTrainedModel.js';
import {
    DistilBertModel,
...
} from './classes/DistilBertPreTrainedModel.js';
import { DonutSwinModel } from './classes/DonutSwinPreTrainedModel.js';
import { EfficientNetModel, EfficientNetForImageClassification } from './classes/EfficientNetPreTrainedModel.js';
import {
    ElectraModel,
    ElectraForMaskedLM,
...
} from './classes/ElectraPreTrainedModel.js';
import { Ernie4_5_Model, Ernie4_5_ForCausalLM } from './classes/Ernie4_5_PretrainedModel.js';
import {
    EsmModel,
    EsmForMaskedLM,
    EsmForSequenceClassification,
    EsmForTokenClassification,
} from './classes/EsmPreTrainedModel.js';
import { ExaoneModel, ExaoneForCausalLM } from './classes/ExaonePreTrainedModel.js';
import { FalconModel, FalconForCausalLM } from './classes/FalconPreTrainedModel.js';
import { FastViTModel, FastViTForImageClassification } from './classes/FastViTPreTrainedModel.js';
import { Florence2ForConditionalGeneration } from './classes/Florence2PreTrainedModel.js';
import { GLPNModel, GLPNForDepthEstimation } from './classes/GLPNPreTrainedModel.js';
import { GPT2Model, GPT2LMHeadModel } from './classes/GPT2PreTrainedModel.js';
import { GPTBigCodeModel, GPTBigCodeForCausalLM } from './classes/GPTBigCodePreTrainedModel.js';
import { GPTJModel, GPTJForCausalLM } from './classes/GPTJPreTrainedModel.js';
import { GPTNeoModel, GPTNeoForCausalLM } from './classes/GPTNeoPreTrainedModel.js';
import { GPTNeoXModel, GPTNeoXForCausalLM } from './classes/GPTNeoXPreTrainedModel.js';
import { Gemma2Model, Gemma2ForCausalLM } from './classes/Gemma2PreTrainedModel.js';
import { Gemma3Model, Gemma3ForCausalLM } from './classes/Gemma3PreTrainedModel.js';
import { Gemma3nForConditionalGeneration } from './classes/Gemma3nPreTrainedModel.js';
import { GemmaModel, GemmaForCausalLM } from './classes/GemmaPreTrainedModel.js';
import { GlmModel, GlmForCausalLM } from './classes/GlmPreTrainedModel.js';
import { GptOssModel, GptOssForCausalLM } from './classes/GptOssPreTrainedModel.js';
import { GraniteMoeHybridModel, GraniteMoeHybridForCausalLM } from './classes/GraniteMoeHybridPreTrainedModel.js';
import { GraniteModel, GraniteForCausalLM } from './classes/GranitePreTrainedModel.js';
import { GroundingDinoForObjectDetection } from './classes/GroundingDinoPreTrainedModel.js';
import { GroupViTModel } from './classes/GroupViTPreTrainedModel.js';
import { HeliumModel, HeliumForCausalLM } from './classes/HeliumPreTrainedModel.js';
import { HieraModel, HieraForImageClassification } from './classes/HieraPreTrainedModel.js';
import { HubertModel, HubertForCTC, HubertForSequenceClassification } from './classes/HubertPreTrainedModel.js';
import { IJepaModel, IJepaForImageClassification } from './classes/IJepaPreTrainedModel.js';
import {
    Idefics3ForConditionalGeneration,
    SmolVLMForConditionalGeneration,
} from './classes/Idefics3PreTrainedModel.js';
import { JAISModel, JAISLMHeadModel } from './classes/JAISPreTrainedModel.js';
import { JinaCLIPModel, JinaCLIPTextModel, JinaCLIPVisionModel } from './classes/JinaCLIPPreTrainedModel.js';
import { Lfm2Model, Lfm2ForCausalLM } from './classes/Lfm2PreTrainedModel.js';
import { Llama4ForCausalLM } from './classes/Llama4PreTrainedModel.js';
import { LlamaModel, LlamaForCausalLM } from './classes/LlamaPreTrainedModel.js';
import {
    LlavaForConditionalGeneration,
    LlavaOnevisionForConditionalGeneration,
    Moondream1ForConditionalGeneration,
    LlavaQwen2ForCausalLM,
} from './classes/LlavaPreTrainedModel.js';
import { LongT5Model, LongT5ForConditionalGeneration } from './classes/LongT5PreTrainedModel.js';
import { M2M100Model, M2M100ForConditionalGeneration } from './classes/M2M100PreTrainedModel.js';
import {
    MBartModel,
    MBartForConditionalGeneration,
    MBartForSequenceClassification,
    MBartForCausalLM,
} from './classes/MBartPreTrainedModel.js';
import {
    MPNetModel,
    MPNetForMaskedLM,
...
} from './classes/MPNetPreTrainedModel.js';
import { MT5Model, MT5ForConditionalGeneration } from './classes/MT5PreTrainedModel.js';
import { MarianModel, MarianMTModel } from './classes/MarianPreTrainedModel.js';
import { MaskFormerModel, MaskFormerForInstanceSegmentation } from './classes/MaskFormerPreTrainedModel.js';
import { Metric3DForDepthEstimation } from './classes/Metric3DPreTrainedModel.js';
import { Metric3Dv2ForDepthEstimation } from './classes/Metric3Dv2PreTrainedModel.js';
import { MgpstrForSceneTextRecognition } from './classes/MgpstrPreTrainedModel.js';
import { MimiModel, MimiEncoderModel, MimiDecoderModel } from './classes/MimiPreTrainedModel.js';
import { MistralModel, MistralForCausalLM } from './classes/MistralPreTrainedModel.js';
import {
    MobileBertModel,
    MobileBertForMaskedLM,
    MobileBertForSequenceClassification,
    MobileBertForQuestionAnswering,
} from './classes/MobileBertPreTrainedModel.js';
import { MobileLLMModel, MobileLLMForCausalLM } from './classes/MobileLLMPreTrainedModel.js';
import {
    MobileNetV1Model,
    MobileNetV1ForImageClassification,
    MobileNetV1ForSemanticSegmentation,
} from './classes/MobileNetV1PreTrainedModel.js';
import {
    MobileNetV2Model,
    MobileNetV2ForImageClassification,
    MobileNetV2ForSemanticSegmentation,
} from './classes/MobileNetV2PreTrainedModel.js';
import {
    MobileNetV3Model,
    MobileNetV3ForImageClassification,
    MobileNetV3ForSemanticSegmentation,
} from './classes/MobileNetV3PreTrainedModel.js';
import {
    MobileNetV4Model,
    MobileNetV4ForImageClassification,
    MobileNetV4ForSemanticSegmentation,
} from './classes/MobileNetV4PreTrainedModel.js';
import { MobileViTModel, MobileViTForImageClassification } from './classes/MobileViTPreTrainedModel.js';
import { MobileViTV2Model, MobileViTV2ForImageClassification } from './classes/MobileViTV2PreTrainedModel.js';
import { ModernBertDecoderModel, ModernBertDecoderForCausalLM } from './classes/ModernBertDecoderPreTrainedModel.js';
import {
    ModernBertModel,
    ModernBertForMaskedLM,
    ModernBertForSequenceClassification,
    ModernBertForTokenClassification,
} from './classes/ModernBertPreTrainedModel.js';
import { MoonshineForConditionalGeneration } from './classes/MoonshinePreTrainedModel.js';
import { MptModel, MptForCausalLM } from './classes/MptPreTrainedModel.js';
import { MultiModalityCausalLM } from './classes/MultiModalityPreTrainedModel.js';
import { MusicgenForConditionalGeneration } from './classes/MusicgenPreTrainedModel.js';
import { NanoChatModel, NanoChatForCausalLM } from './classes/NanoChatPreTrainedModel.js';
import {
    NeoBertModel,
    NeoBertForMaskedLM,
...
} from './classes/NeoBertPreTrainedModel.js';
import { NomicBertModel } from './classes/NomicBertPreTrainedModel.js';
import { OPTModel, OPTForCausalLM } from './classes/OPTPreTrainedModel.js';
import { Olmo2Model, Olmo2ForCausalLM } from './classes/Olmo2PreTrainedModel.js';
import { Olmo3Model, Olmo3ForCausalLM } from './classes/Olmo3PreTrainedModel.js';
import { OlmoModel, OlmoForCausalLM } from './classes/OlmoPreTrainedModel.js';
import { OpenELMModel, OpenELMForCausalLM } from './classes/OpenELMPreTrainedModel.js';
import { OwlViTModel, OwlViTForObjectDetection } from './classes/OwlViTPreTrainedModel.js';
import { Owlv2Model, Owlv2ForObjectDetection } from './classes/Owlv2PreTrainedModel.js';
import { PaliGemmaForConditionalGeneration } from './classes/PaliGemmaPreTrainedModel.js';
import { ParakeetForCTC } from './classes/ParakeetPreTrainedModel.js';
import { PatchTSMixerModel, PatchTSMixerForPrediction } from './classes/PatchTSMixerPreTrainedModel.js';
import { PatchTSTModel, PatchTSTForPrediction } from './classes/PatchTSTPreTrainedModel.js';
import { Phi3Model, Phi3ForCausalLM } from './classes/Phi3PreTrainedModel.js';
import { Phi3VForCausalLM } from './classes/Phi3VPreTrainedModel.js';
import { PhiModel, PhiForCausalLM } from './classes/PhiPreTrainedModel.js';
import { PvtModel, PvtForImageClassification } from './classes/PvtPreTrainedModel.js';
import { PyAnnoteModel, PyAnnoteForAudioFrameClassification } from './classes/PyAnnotePreTrainedModel.js';
import { Qwen2Model, Qwen2ForCausalLM } from './classes/Qwen2PreTrainedModel.js';
import { Qwen2VLForConditionalGeneration } from './classes/Qwen2VLPreTrainedModel.js';
import { Qwen3Model, Qwen3ForCausalLM } from './classes/Qwen3PreTrainedModel.js';
import { RFDetrModel, RFDetrForObjectDetection } from './classes/RFDetrPreTrainedModel.js';
import { RTDetrModel, RTDetrForObjectDetection } from './classes/RTDetrPreTrainedModel.js';
import { RTDetrV2Model, RTDetrV2ForObjectDetection } from './classes/RTDetrV2PreTrainedModel.js';
import { ResNetModel, ResNetForImageClassification } from './classes/ResNetPreTrainedModel.js';
import {
    RoFormerModel,
    RoFormerForMaskedLM,
...
} from './classes/RoFormerPreTrainedModel.js';
import {
    RobertaModel,
    RobertaForMaskedLM,
...
} from './classes/RobertaPreTrainedModel.js';
import { Sam2Model, EdgeTamModel, Sam3TrackerModel } from './classes/Sam2PreTrainedModel.js';
import { SamModel } from './classes/SamPreTrainedModel.js';
import {
    SapiensForSemanticSegmentation,
    SapiensForDepthEstimation,
    SapiensForNormalEstimation,
} from './classes/SapiensPreTrainedModel.js';
import {
    SegformerForImageClassification,
    SegformerForSemanticSegmentation,
} from './classes/SegformerPreTrainedModel.js';
import { SiglipModel, SiglipTextModel, SiglipVisionModel } from './classes/SiglipPreTrainedModel.js';
import { SmolLM3Model, SmolLM3ForCausalLM } from './classes/SmolLM3PreTrainedModel.js';
import { SnacModel, SnacEncoderModel, SnacDecoderModel } from './classes/SnacPreTrainedModel.js';
import {
    SpeechT5ForSpeechToText,
    SpeechT5ForTextToSpeech,
    SpeechT5HifiGan,
} from './classes/SpeechT5PreTrainedModel.js';
import {
    SqueezeBertModel,
    SqueezeBertForMaskedLM,
    SqueezeBertForSequenceClassification,
    SqueezeBertForQuestionAnswering,
} from './classes/SqueezeBertPreTrainedModel.js';
import { StableLmModel, StableLmForCausalLM } from './classes/StableLmPreTrainedModel.js';
import { Starcoder2Model, Starcoder2ForCausalLM } from './classes/Starcoder2PreTrainedModel.js';
import { StyleTextToSpeech2Model } from './classes/StyleTextToSpeech2PreTrainedModel.js';
import { SupertonicForConditionalGeneration } from './classes/SupertonicPreTrainedModel.js';
import { Swin2SRModel, Swin2SRForImageSuperResolution } from './classes/Swin2SRPreTrainedModel.js';
import { SwinModel, SwinForImageClassification, SwinForSemanticSegmentation } from './classes/SwinPreTrainedModel.js';
import { T5Model, T5ForConditionalGeneration } from './classes/T5PreTrainedModel.js';
import {
    TableTransformerModel,
    TableTransformerForObjectDetection,
} from './classes/TableTransformerPreTrainedModel.js';
import { TrOCRForCausalLM } from './classes/TrOCRPreTrainedModel.js';
import { UltravoxModel, VoxtralForConditionalGeneration } from './classes/UltravoxPreTrainedModel.js';
import {
    UniSpeechModel,
    UniSpeechForCTC,
    UniSpeechForSequenceClassification,
} from './classes/UniSpeechPreTrainedModel.js';
import {
    UniSpeechSatModel,
    UniSpeechSatForCTC,
    UniSpeechSatForSequenceClassification,
    UniSpeechSatForAudioFrameClassification,
} from './classes/UniSpeechSatPreTrainedModel.js';
import { VaultGemmaModel, VaultGemmaForCausalLM } from './classes/VaultGemmaPreTrainedModel.js';
import { ViTMAEModel } from './classes/ViTMAEPreTrainedModel.js';
import { ViTMSNModel, ViTMSNForImageClassification } from './classes/ViTMSNPreTrainedModel.js';
import { ViTModel, ViTForImageClassification } from './classes/ViTPreTrainedModel.js';
import { VisionEncoderDecoderModel } from './classes/VisionEncoderDecoderModel.js';
import { VitMatteForImageMatting } from './classes/VitMattePreTrainedModel.js';
import { VitPoseForPoseEstimation } from './classes/VitPosePreTrainedModel.js';
import { VitsModel } from './classes/VitsPreTrainedModel.js';
import {
    Wav2Vec2BertModel,
    Wav2Vec2BertForCTC,
    Wav2Vec2BertForSequenceClassification,
} from './classes/Wav2Vec2BertPreTrainedModel.js';
import {
    Wav2Vec2Model,
    Wav2Vec2ForCTC,
    Wav2Vec2ForSequenceClassification,
    Wav2Vec2ForAudioFrameClassification,
} from './classes/Wav2Vec2PreTrainedModel.js';
import {
    WavLMModel,
    WavLMForCTC,
...
} from './classes/WavLMPreTrainedModel.js';
import { WeSpeakerResNetModel } from './classes/WeSpeakerResNetPreTrainedModel.js';
import {
    WhisperModel,
    WhisperForConditionalGeneration,
    LiteWhisperForConditionalGeneration,
} from './classes/WhisperPreTrainedModel.js';
import {
    XLMModel,
    XLMWithLMHeadModel,
...
} from './classes/XLMPreTrainedModel.js';
import {
    XLMRobertaModel,
...
} from './classes/XLMRobertaPreTrainedModel.js';
import { YolosModel, YolosForObjectDetection } from './classes/YolosPreTrainedModel.js';
